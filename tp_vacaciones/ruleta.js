...
var Ruleta = /** @class */ (function () {
    function Ruleta(juegoAbierto) {
        this.juegoAbierto = juegoAbierto;
    }
    Ruleta.prototype.getJuegoAbierto = function () {
    ...
    Ruleta.prototype.getGirar = function () {
        var apuesta = RLS.questionInt("Ingrese el monto que desea apostar, 0 para salir del juego: ");
        var arregloNumeros = [
